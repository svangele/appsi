                      ...
                      child: Column(
                        children: [
                          ...
                          if (_profile?['cssi_contributors'] != null) ...[
                            ...
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.person, 'Director', _profile?['cssi_contributors']?['director'] ?? '---'),
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.manage_accounts, 'Gerente regional', _profile?['cssi_contributors']?['gerente_regional'] ?? '---'),
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.person_pin, 'Jefe inmediato', _profile?['cssi_contributors']?['jefe_inmediato'] ?? '---'),
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.groups, 'Líder', _profile?['cssi_contributors']?['lider'] ?? '---'),
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.phone_outlined, 'Teléfono', _profile?['cssi_contributors']?['telefono'] ?? '---'),
                            const SizedBox(height: 12),
                            _buildInfoRow(Icons.phone_android, 'Teléfono celular', _profile?['cssi_contributors']?['celular'] ?? '---'),
                            const SizedBox(height: 12),
