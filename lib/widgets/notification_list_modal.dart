                ...
                : _notifications.isEmpty
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            elevation: 0,
                            color: isUnread ? theme.colorScheme.primary.withValues(alpha: 0.05) : Colors.white,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12),
                              side: BorderSide(
                                color: isUnread ? theme.colorScheme.primary.withValues(alpha: 0.2) : Colors.grey[200]!,
                              ),
                            ),
                            child: ListTile(
                              onTap: () async {
