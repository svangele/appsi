                  ...
                  child: ElevatedButton(
                    onPressed: saving ? null : () async {
                      ...
                      final data = {
                        ...
                        'curp': curpCtrl.text.trim().isEmpty ? null : curpCtrl.text.trim(),
                        'rfc': rfcCtrl.text.trim().isEmpty ? null : rfcCtrl.text.trim(),
                        'imss': imssCtrl.text.trim(),
                        'credito': credito,
                        ...
                        'detalle_escolaridad': detalleEscolCtrl.text,
                        'calle': calleCtrl.text,
                        'no_calle': noCalleCtrl.text,
                        'colonia': coloniaCtrl.text,
                        'municipio_alcaldia': municipioCtrl.text,
                        'estado_federal': estadoFedCtrl.text,
                        'codigo_postal': cpCtrl.text,
                        'telefono': telCtrl.text,
                        'celular': celCtrl.text,
                        'correo_personal': correoCtrl.text,
                        'banco': bancoCtrl.text,
                        'cuenta': cuentaCtrl.text,
                        'clabe': clabeCtrl.text,
                        'area': areaCtrl.text,
                        'puesto': puestoCtrl.text,
                        'ubicacion': ubicacionCtrl.text,
                        'empresa': empresaCtrl.text,
                        'jefe_inmediato': jefeCtrl.text,
                        'lider': liderCtrl.text,
                        'gerente_regional': gerenteCtrl.text,
                        'director': directorCtrl.text,
                        'recluta': reclutaCtrl.text,
                        'reclutador': reclutadorCtrl.text,
                        'fuente_reclutamiento': fuenteCtrl.text,
                        'fuente_reclutamiento_espec': fuenteEspecCtrl.text,
                        'observaciones': obsCtrl.text,
                        'referencia_nombre': refNombreCtrl.text,
                        'referencia_telefono': refTelCtrl.text,
                        'referencia_relacion': refRelacionCtrl.text,
